        ...
        Item {
            ...
            GridView {
                ...
                delegate: Item {
                    ...
                    property bool previewReady: thumbnailImage.status === Image.Ready
                    property bool revealReady: false
                    property bool showPreview: revealReady && previewReady

                    opacity: root.enableAnimation ? (revealReady ? 1 : 0) : 1
                    scale: root.enableAnimation ? (revealReady ? 1 : 0.965) : 1
                    ...
                    function scheduleReveal() {
                        ...
                        revealReady = false;
                        revealTimer.interval = 40 + index * 18;
                        revealTimer.restart();
                    }

                    Component.onCompleted: scheduleReveal()

                    Connections {
                        target: root

                        function onEnableAnimationChanged() {
                            wallpaperDelegate.scheduleReveal();
                        }
                    }
                    ...
                    Timer {
                        ...
                        interval: 40
                        repeat: false
                        onTriggered: wallpaperDelegate.revealReady = true
                    }
                    ...
                    Rectangle {
                        ...
                        CachingImage {
                            ...
                            opacity: wallpaperDelegate.showPreview ? 1 : 0
                        ...
                        Rectangle {
                            ...
                            opacity: wallpaperDelegate.showPreview ? 0 : 1
                        ...
                        BusyIndicator {
                            ...
                            width: 26
                            height: 26
                            running: !wallpaperDelegate.showPreview && wallpaperPath !== ""
                            visible: running
                            opacity: running ? 1 : 0
