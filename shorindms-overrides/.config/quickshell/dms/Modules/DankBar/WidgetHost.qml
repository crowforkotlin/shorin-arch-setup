...
Loader {
    ...
    function getWidgetComponent(widgetId, components) {
        const componentMap = {
            ...
            "screenshotTools": components.screenshotToolsComponent,
            "screenRecordButton": components.screenRecordButtonComponent,
            "captureTools": components.captureToolsComponent,
    ...
    function getWidgetVisible(widgetId, dgopAvailable) {
        const widgetVisibility = {
            ...
            "screenshotTools": CompositorService.isNiri,
            "screenRecordButton": CompositorService.isNiri,
