...
Item {
    ...
    function applyGeometricLayout() {
        ...
        for (var i = 0; i < centerRepeater.count; i++) {
            ...
            if (wrapper && wrapper.active && wrapper.item) {
    ...
    onWidgetsModelChanged: layoutTimer.restart()
    onWidgetSpacingChanged: layoutTimer.restart()
    onIsVerticalChanged: layoutTimer.restart()
    ...
    Repeater {
        ...
        Item {
            ...
            onItemDataChanged: layoutTimer.restart()
