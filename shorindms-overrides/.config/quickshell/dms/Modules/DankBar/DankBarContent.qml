...
Item {
    ...
    readonly property real edgeInset: Math.max(0, barConfig?.edgeInset ?? barConfig?.spacing ?? 4)
    readonly property real horizontalEdgeMargin: Math.max(Theme.spacingXS, innerPadding * 0.8, edgeInset)
    readonly property real verticalEdgeMargin: Math.max(Theme.spacingXS, edgeInset)
    ...
    anchors.fill: parent
    anchors.leftMargin: horizontalEdgeMargin
    anchors.rightMargin: horizontalEdgeMargin
    anchors.topMargin: barWindow.isVertical ? Math.max(barWindow.hasAdjacentTopBar ? outlineThickness : Theme.spacingXS, verticalEdgeMargin) : 0
    anchors.bottomMargin: barWindow.isVertical ? Math.max(barWindow.hasAdjacentBottomBar ? outlineThickness : Theme.spacingXS, verticalEdgeMargin) : 0
    clip: false
    ...
    readonly property var widgetVisibility: ({
            ...
            "captureTools": CompositorService.isNiri
        })
    ...
    readonly property var componentMap: {
        ...
        let baseMap = {
            ...
            "screenshotTools": screenshotToolsComponent,
            "screenRecordButton": screenRecordButtonComponent,
            "captureTools": captureToolsComponent,
    ...
    readonly property var allComponents: ({
            ...
            "screenshotToolsComponent": screenshotToolsComponent,
            "screenRecordButtonComponent": screenRecordButtonComponent,
            "captureToolsComponent": captureToolsComponent,
    ...
    Component {
        id: screenRecordButtonComponent
