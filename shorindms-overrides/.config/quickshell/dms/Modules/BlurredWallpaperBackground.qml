    ...
    PanelWindow {
        ...
        Item {
            ...
            Connections {
                ...
                function onMonitorWallpapersLightChanged() {
                    root.syncSource();
                }
                function onMonitorWallpapersDarkChanged() {
                    root.syncSource();
                }
            ...
            function _recheckScreenScale() {
                ...
                if (newScale !== root.screenScale) {
                    console.info("BlurredWallpaperBackground: screen scale corrected for", modelData.name + ":", root.screenScale, "->", newScale);
