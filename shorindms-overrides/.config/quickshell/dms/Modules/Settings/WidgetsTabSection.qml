    ...
    RowLayout {
        ...
        RowLayout {
            ...
            DankActionButton {
                ...
                onEntered: {
                    sharedTooltip.show(I18n.tr("Widget-aware Centering"), indexCenterButton, 0, 0, "bottom");
                }
                onExited: {
                    sharedTooltip.hide();
                }
            ...
            DankActionButton {
                ...
                onEntered: {
                    sharedTooltip.show(I18n.tr("Waybar-style Centering"), geometricCenterButton, 0, 0, "bottom");
                }
                onExited: {
                    sharedTooltip.hide();
                }
