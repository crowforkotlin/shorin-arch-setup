...
Item {
    ...
    function effectiveLanguageValue() {
        if (SettingsData.dmsLanguage === "zh_CN" || SettingsData.dmsLanguage === "en")
            return SettingsData.dmsLanguage;
        return (Qt.locale().name || "").toLowerCase().startsWith("zh") ? "zh_CN" : "en";
    }
    ...
    DankFlickable {
        ...
        Column {
            ...
            SettingsCard {
                tab: "typography"
                tags: ["language", "locale", "translation", "interface"]
                title: I18n.tr("Language")
                settingKey: "dmsLanguage"
                iconName: "translate"

                Item {
                    width: parent.width
                    height: languageDescription.implicitHeight + languageButtons.height + Theme.spacingM

                    StyledText {
                        id: languageDescription
                        text: I18n.tr("Only changes DMS language and menus launched by DMS. Does not rewrite system LANG/LANGUAGE.")
                    ...
                    Column {
                        ...
                        width: parent.width - Theme.spacingM * 2
                        x: Theme.spacingM
                        y: languageDescription.implicitHeight + Theme.spacingM
                        spacing: Theme.spacingS

                        Rectangle {
                            readonly property bool selected: root.effectiveLanguageValue() === "zh_CN"
                            width: parent.width
                            height: 38
                            ...
                            DankRipple {
                                ...
                                rippleColor: selected ? Theme.buttonText : Theme.surfaceVariantText
                            }
                            ...
                            MouseArea {
                                ...
                                onPressed: mouse => chineseRipple.trigger(mouse.x, mouse.y)
                                onClicked: {
                                    if (I18n.setLocaleOverride)
                                        I18n.setLocaleOverride("zh_CN");
                                    SettingsData.set("dmsLanguage", "zh_CN");
                                }
                            }
                        }

                        Rectangle {
                            readonly property bool selected: root.effectiveLanguageValue() === "en"
                            width: parent.width
                            height: 38
                            radius: Theme.cornerRadius
                            color: selected ? Theme.buttonBg : Theme.withAlpha(Theme.surfaceVariant, Theme.popupTransparency)
                            ...
                            MouseArea {
                                ...
                                hoverEnabled: true
                                cursorShape: Qt.PointingHandCursor
                                onPressed: mouse => englishRipple.trigger(mouse.x, mouse.y)
                                onClicked: {
                                    if (I18n.setLocaleOverride)
                                        I18n.setLocaleOverride("en");
                                    SettingsData.set("dmsLanguage", "en");
                                }
                            }
                        }
                    }
