...
Item {
    ...
    function triggerWallpaperSurfaceRecovery() {
        wallpaperSurfaceRecoveryTimer.pass = 0;
        wallpaperSurfaceRecoveryTimer.interval = 800;
        wallpaperSurfaceRecoveryTimer.restart();
    }
    ...
    Timer {
        id: wallpaperSurfaceReloadTimer
        interval: 0
        repeat: false
    ...
    Connections {
        ...
        function onScreensChanged() {
            ...
            if (!root.hadRealScreen && hasReal) {
                root.triggerWallpaperSurfaceRecovery();
            }
    ...
    Timer {
        id: wallpaperSurfaceRecoveryTimer
        interval: 800
        repeat: false
        property int pass: 0
        onTriggered: {
            ...
            if (root.wallpaperSurfacesLoaded) {
                ...
                wallpaperSurfaceReloadTimer.start();
            }
    ...
    Component.onCompleted: {
        root.hadRealScreen = root._hasRealScreen();
