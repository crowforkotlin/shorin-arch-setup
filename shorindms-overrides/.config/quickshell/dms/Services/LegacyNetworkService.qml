...
Singleton {
    ...
    function connectToWifi(ssid, password = "", username = "", anonymousIdentity = "", domainSuffixMatch = "") {
        ...
        if (!network) {
            console.warn("LegacyNetworkService: SSID not found in scan results:", ssid);
        ...
        if (password) {
            ...
            case WifiSecurityType.Sae:
                ...
                return;
            default:
                console.warn("LegacyNetworkService: Security type not supported with PSK, falling back to connect():", WifiSecurityType.toString(sec));
            }
        }
    ...
    function forgetWifiNetwork(ssid) {
        ...
        if (network) {
            ...
            console.warn("LegacyNetworkService: Cannot forget, SSID not found:", ssid);
        }
        forgetSSID = "";
    }
