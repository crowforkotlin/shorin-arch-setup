...
Singleton {
    ...
    property string dmsLanguage: "system"
    onDmsLanguageChanged: syncI18nLocaleOverride()
    ...
    property var barConfigs: [
        {
            ...
            "centerWidgets": ["music", "screenshotTools", "clock", "screenRecordButton", "weather"],
    ...
    function syncI18nLocaleOverride() {
        if (typeof I18n === "undefined" || !I18n.setLocaleOverride)
            return;
        I18n.setLocaleOverride(dmsLanguage === "system" ? "" : dmsLanguage);
    }
